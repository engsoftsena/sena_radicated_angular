...
@Component({
  selector: 'app-em-security',
  templateUrl: './em-security.component.html',
  styleUrls: ['./em-security.component.scss']
})
export class EmSecurityComponent implements OnInit {
  ...
  tableComponent: string = 'em_security';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `security,${this.syPrefixId}`,
    };
