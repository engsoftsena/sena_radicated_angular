...
@Component({
  selector: 'app-em-hosting',
  templateUrl: './em-hosting.component.html',
  styleUrls: ['./em-hosting.component.scss']
})
export class EmHostingComponent implements OnInit {
  ...
  tableComponent: string = 'em_hosting';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `hosting,${this.syPrefixId}`,
    };
