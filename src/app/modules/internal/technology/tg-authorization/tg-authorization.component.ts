...
@Component({
  selector: 'app-tg-authorization',
  templateUrl: './tg-authorization.component.html',
  styleUrls: ['./tg-authorization.component.scss']
})
export class TgAuthorizationComponent implements OnInit {
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `authorization,${this.syPrefixId}`,
    };
