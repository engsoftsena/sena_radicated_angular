...
@Component({
  selector: 'app-tg-action',
  templateUrl: './tg-action.component.html',
  styleUrls: ['./tg-action.component.scss']
})
export class TgActionComponent implements OnInit {
  ...
  tableComponent: string = 'tg_action';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `action,${this.syPrefixId}`,
    };
