...
@Component({
  selector: 'app-us-proccess',
  templateUrl: './us-proccess.component.html',
  styleUrls: ['./us-proccess.component.scss']
})
export class UsProccessComponent implements OnInit {
  ...
  tableComponent: string = 'us_proccess';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `proccess,${this.syPrefixId}`,
    };
