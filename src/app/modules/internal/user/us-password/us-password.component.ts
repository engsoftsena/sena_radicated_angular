...
@Component({
  selector: 'app-us-password',
  templateUrl: './us-password.component.html',
  styleUrls: ['./us-password.component.scss']
})
export class UsPasswordComponent implements OnInit {
  ...
  tableComponent: string = 'us_password';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `password,${this.syPrefixId}`,
    };
