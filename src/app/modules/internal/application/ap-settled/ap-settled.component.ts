...
@Component({
  ...
  styleUrls: ['./ap-settled.component.scss']
})
export class ApSettledComponent implements OnInit {
  ...
  tableComponent: string = 'ap_settled';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `settled,${this.syPrefixId}`,
    };
