...
import { ApRequestModule } from 'src/app/interfaces/modules/application/request.interface';
...
// Importacion de Servicios
import { RequestService } from 'src/app/services/modules/application/ap-request/ap-request.service';
...
export class ApRequestComponent implements OnInit {
  ...
  tableComponent: string = 'ap_request';
  tableSysEliminate: string = 'sy_eliminate';
  deletedData: any;
  isLoading: boolean = false;
  columnSet: [] | undefined;
  requestData: ApRequestModule[] = [];
