...
@Component({
  selector: 'app-sy-icon',
  templateUrl: './sy-icon.component.html',
  styleUrls: ['./sy-icon.component.scss']
})
export class SyIconComponent implements OnInit {
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `icon,${this.syPrefixId}`,
    };
  ...
  helpMssg() {
    let fieldHelp = {
      ...
      'os_name': {
        ...
        'hyphen': 'Permitido caracteres de guiones',
