...
@Component({
  selector: 'app-sy-select',
  templateUrl: './sy-select.component.html',
  styleUrls: ['./sy-select.component.scss']
})
export class SySelectComponent implements OnInit {
  ...
  tableComponent: string = 'sy_select';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `select,${this.syPrefixId}`,
    };
