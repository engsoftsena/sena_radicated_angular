...
@Component({
  selector: 'app-sy-eliminate',
  templateUrl: './sy-eliminate.component.html',
  styleUrls: ['./sy-eliminate.component.scss']
})
export class SyEliminateComponent implements OnInit {
  ...
  tableComponent: string = 'sy_eliminate';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `eliminate,${this.syPrefixId}`,
    };
