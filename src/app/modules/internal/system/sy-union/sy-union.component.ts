...
@Component({
  selector: 'app-sy-union',
  templateUrl: './sy-union.component.html',
  styleUrls: ['./sy-union.component.scss']
})
export class SyUnionComponent implements OnInit {
  ...
  tableComponent: string = 'sy_union';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `union,${this.syPrefixId}`,
    };
