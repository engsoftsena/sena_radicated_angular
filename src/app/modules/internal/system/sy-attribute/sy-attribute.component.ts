...
@Component({
  selector: 'app-sy-attribute',
  templateUrl: './sy-attribute.component.html',
  styleUrls: ['./sy-attribute.component.scss']
})
export class SyAttributeComponent implements OnInit {
  ...
  tableComponent: string = 'sy_attribute';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `attribute,${this.syPrefixId}`,
    };
