...
@Component({
  selector: 'app-sy-relation',
  templateUrl: './sy-relation.component.html',
  styleUrls: ['./sy-relation.component.scss']
})
export class SyRelationComponent implements OnInit {
  ...
  tableComponent: string = 'sy_relation';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `relation,${this.syPrefixId}`,
    };
