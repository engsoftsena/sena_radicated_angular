...
@Component({
  selector: 'app-sy-prefix',
  templateUrl: './sy-prefix.component.html',
  styleUrls: ['./sy-prefix.component.scss']
})
export class SyPrefixComponent implements OnInit {
  ...
  tableComponent: string = 'sy_prefix';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `prefix,${this.syPrefixId}`,
    };
