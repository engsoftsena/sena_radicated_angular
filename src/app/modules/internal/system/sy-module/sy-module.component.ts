...
@Component({
  selector: 'app-sy-module',
  templateUrl: './sy-module.component.html',
  styleUrls: ['./sy-module.component.scss']
})
export class SyModuleComponent implements OnInit {
  ...
  tableComponent: string = 'sy_module';
  ...
  syModuleData(response: any) {
    ...
    const params = {
      ...
      whereOperator: `=,=`,
      whereEqual: `module,${this.syPrefixId}`,
    };
